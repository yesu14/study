...
def page0():
    ...
    turtle.goto(-350, -50)
    turtle.color('pink')
    turtle.write('사랑이란 말로 \n모든걸 표현하기에는\n부족할때가 많습니다', font=('나눔손글씨 붓', 60, 'normal'))
    time.sleep(3)
...
def page2():
    ...
    turtle.color('green')
    turtle.pendown()
    # turtle.write('天天     美美', font=('wisdom', 50, 'normal'))
    turtle.write('天天         美美', font=('华文彩云', 50, 'normal'))
    turtle.penup()
    turtle.goto(0, -180)
    draw_heart(10)
